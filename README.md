...
The current suite contains 40 passing automated tests. Release acceptance also includes a real Mainnet three-device founder-gift journey: device one accepted a prepaid 5,000 NIM gift, passed the same gift to device two through a normal private URL, and the final recipient kept it. This validates the differentiating addressless Accept → Pass → Keep flow with real NIM rather than a mocked wallet.

## Competition promotion evidence

- Skool: https://www.skool.com/miniappscompetition/we-talk-about-paying-it-forward-but-what-about-paying-it-sideways?p=0efb3e0f
